  ...
  return (
    <div className="h-screen bg-slate-50 dark:bg-slate-900 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex min-h-0">
        ...
        {/* Interaction Panel */}
        {!isFullscreen && (
          <div className="w-1/3 flex flex-col min-h-0 bg-slate-50 dark:bg-slate-900" id="chat-panel">
            <Tabs defaultValue="chat" className="flex-1 flex flex-col min-h-0">
              ...
              <TabsContent value="chat" className="flex-1 flex flex-col mx-2 mb-2 min-h-0">
                <Card className="flex-1 flex flex-col min-h-0 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-slate-200 dark:border-slate-700 shadow-sm">
