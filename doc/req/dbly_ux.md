...
| :--- | :--- | :--- | :--- |
| 1. 访问学生端 | 小明打开学生端的专属网址。 | 直接进入学生主面板/实验列表页，无需登录。 | 一键直达，操作快捷。 |
...
| 步骤 | 用户行为 | 系统交互与界面反馈 | 体验要点 |
| :--- | :--- | :--- | :--- |
| 1. 进入实验 | 小明在实验室电脑上打开学生端网址，选择“负反馈放大电路”，点击“开始实验”。 | 系统加载一个分栏视图：左侧是官方实验讲义，右侧是AI问答聊天窗口。讲义定位到当前实验。 | 界面布局合理，讲义和问答区共存且互不干扰。 |
...
| 步骤 | 用户行为 | 系统交互与界面反馈 | 体验要点 |
| :--- | :--- | :--- | :--- |
| 1. 访问管理后台 | 王老师访问特定的后台管理网址。 | 直接进入管理后台主面板，无需登录。 | 通过特定URL访问，安全且便捷。 |
| 2. 进入讲义管理 | 登录后进入管理后台主页，王老师点击侧边栏的“实验内容管理”。 | 后台界面布局清晰，导航明确（如Dashboard, 内容管理等）。 | 后台功能组织有序，易于导航。 |
